...
//------------------Set initial position of each card
    ...
    $($($mountain)[3]).offset({top: 50, left: 400});
    $($($mountain)[0]).offset({top: 50, left: 1100});
    $($($mountain)[2]).offset({top: 500, left: 400});
    $($($mountain)[1]).offset({top: 500, left: 1100});
