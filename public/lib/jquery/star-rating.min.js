...
(function ($) {
    ...
    Rating.prototype = {
        ...
        getPosition: function (e) {
            var ev = e.originalEvent.touches?e.originalEvent.touches[0]:e.originalEvent;
            return ev.pageX - this.$rating.offset().left;
        },
        listen: function () {
            var self = this, pos, out;
            self.initTouch();
            self.$rating.on("touchstart mousedown", function (e) {
                if (self.inactive) {
                    return;
                }
...
//            });
        ...
        initTouch: function () {
            var self = this;
            self.$rating.on("touchstart touchmove touchend mousedown", function (e) {
    ...
    $.fn.rating.defaults = {
        ...
        clearCaption: 'Pas Encore Évalué',
